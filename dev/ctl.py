#!/usr/bin/env python3
"""One-shot CLI client for the butterpdf test bridge (see butterpdf/test_bridge.py).

The bridge only listens when the app was launched with BUTTERPDF_TEST_BRIDGE=1.
...
from butterpdf.test_bridge import socket_name  # noqa: E402
...
def call(payload: dict) -> dict:
    ...
    if not sock.waitForConnected(_CONNECT_MS):
        return {
            ...
            f"with BUTTERPDF_TEST_BRIDGE=1 (and the same TMPDIR)?",
        }

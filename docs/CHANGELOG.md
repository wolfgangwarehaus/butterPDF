...
All notable changes to butterpdf are documented here. The format follows
...
### Added
- The baking phase: a single metadata source (`[tool.butterpdf.metadata]`), the
  `butterpdf bake` renderer, and the first channels — PyPI, a loose `.deb`, and an

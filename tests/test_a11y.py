...
controls only, used sparingly (zero in bare butterpdf).
"""
...
from butterpdf.selector import Selector
...
def test_demo_window_all_controls_announce() -> None:
    from butterpdf.app import _placeholder
...
class TestFrostedDialogA11y:
    ...
    def test_focus_lands_on_a_control(self, qapp) -> None:
        from butterpdf.frosted_dialog import FrostedMessageDialog

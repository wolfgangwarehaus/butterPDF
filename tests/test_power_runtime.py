"""Runtime guard for ``butterpdf.power``.

The phantom-import smoke does NOT catch this one: ``butterpdf.power`` imports
...
from butterpdf.power import SleepInhibitor, is_supported

"""butterpdf.credentials — the named-secret store: dual-store with an
...
from butterpdf import credentials as cred
from butterpdf.credentials import _ENC_PREFIX, _decrypt, _encrypt
...
from butterpdf.platform_compat import IS_WINDOWS as _REAL_WINDOWS

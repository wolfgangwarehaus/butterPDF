...
*value* still lives on its original module (``butterpdf.ui_helpers``,
``butterpdf.design_tokens``, ``butterpdf.icons``); this module owns the
...
TOKENS: dict[str, ColorToken] = {
    ...
    "DANGER": ColorToken(
        ...
        module="butterpdf.design_tokens",
    ),

...
from butterpdf.platform_compat import IS_LINUX, IS_MACOS, IS_WINDOWS, is_msix_packaged

if IS_LINUX:
    from butterpdf.autostart import _linux as _backend
elif IS_WINDOWS and is_msix_packaged():
    from butterpdf.autostart import _msix as _backend
elif IS_WINDOWS:
    from butterpdf.autostart import _windows as _backend
elif IS_MACOS:
    from butterpdf.autostart import _macos as _backend
else:

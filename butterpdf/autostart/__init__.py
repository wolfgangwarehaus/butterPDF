...
Linux: writes/reads ~/.config/autostart/butterpdf.desktop (XDG).
...
(see butterpdf/autostart/_flatpak.py for the contract drift).
...
from butterpdf.platform_compat import IS_FLATPAK, IS_LINUX, IS_WINDOWS

if IS_LINUX and IS_FLATPAK:
    from butterpdf.autostart import _flatpak as _backend
elif IS_LINUX:
    from butterpdf.autostart import _linux as _backend
elif IS_WINDOWS:
    from butterpdf.autostart import _windows as _backend
else:
    from butterpdf.autostart import _unsupported as _backend

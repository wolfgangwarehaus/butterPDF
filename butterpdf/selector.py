...
from butterpdf.design_tokens import TYPE_BODY, rad, type_qss
...
def selector_qss(host_selector: str = "") -> str:
    ...
    from butterpdf.ui_helpers import ACCENT, TEXT, TEXT_FAINT, ink_alpha
...
class Selector(QPushButton):
    ...
    def paintEvent(self, e):  # noqa: N802 — Qt naming
        ...
        super().paintEvent(e)
        from butterpdf.icons import _SVG
        from butterpdf.ui_helpers import TEXT
    ...
    def _show_menu(self) -> None:
        from butterpdf.ui_helpers import opaque_menu
    ...
    def _add_list_widget(self, menu, cap_h: int) -> QListWidget:
        ...
        from butterpdf.theme import _hex_to_rgb
        from butterpdf.ui_helpers import (
            ACCENT,
            TEXT,
            ink_alpha,

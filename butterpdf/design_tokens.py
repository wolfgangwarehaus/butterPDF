...
def _load_font_scale() -> float:
    ...
    same handle ``butterpdf.settings`` uses, and the reason the identity seam
...
# Host-OS window-corner radius. butterpdf's frameless surfaces (mini
...
def button_qss(tier: ButtonTier) -> str:
    ...
    """
    from butterpdf.theme import get_active_theme, ink_alpha

...
def probe():
    ...
    butterpdf/blur/__init__.py and docs/research/portable_blur.md.
    ...
    if os.environ.get("FLATPAK_ID"):
        from butterpdf.platform_compat import is_kde_desktop
...
def reason(status):
    ...
    from butterpdf.blur import BlurStatus
    from butterpdf.platform_compat import desktop_name, is_kde_desktop, is_x11

...
visible decoration from butterpdf's server-side-decorated main window. On Windows,
macOS, X11, and non-KDE Wayland (GNOME, Sway, …) butterpdf is either natively framed

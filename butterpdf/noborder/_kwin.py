...
Why this exists: butterpdf's main window is server-side-decorated on KDE Wayland
...
_DESCRIPTION = "butterpdf — borderless frameless main window (managed)"
...
def _qsettings() -> QSettings:
    """The butterpdf identity QSettings handle — the same

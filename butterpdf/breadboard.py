...
**State is a file; the window is a view.** ``butterpdf-breadboard.toml`` sits in the
...
# The board file is named after the APP (butterpdf-breadboard.toml here, myapp-breadboard.toml
# in a fork) — derived from the package, not a literal, so the fork rename can't
# half-apply it (module docstrings say "butterpdf-breadboard.toml" but mean this).
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--init", action="store_true",
                        help="seed a fresh butterpdf-breadboard.toml (refuses to overwrite)")

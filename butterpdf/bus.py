"""AppBus — the app-wide Qt signal bus (butterpdf's decoupling spine).

UI surfaces emit *intents*; controllers react and emit *state*; neither side
holds a reference to the other. butterpdf ships only the GENERIC chrome/app
...
class AppBus(QObject):
    ...
    #                                   butterpdf.updates found a newer release; the
    ...
    #                                   routes it to butterpdf.notifications (no-op where

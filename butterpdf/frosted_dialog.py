...
class FrostedDialog(QDialog):
    ...
    def _build_titlebar(self, title: str, icon_name: str) -> QWidget:
        from butterpdf.design_tokens import TYPE_CAPTION, TYPE_SUBHEAD, type_qss
        from butterpdf.ui_helpers import TEXT, TEXT_DIM, WASH_HOVER
...
class FrostedMessageDialog(FrostedDialog):
    ...
    def __init__(
        ...
        *,
        ...
        from butterpdf.design_tokens import (
            BTN_PRIMARY,
            TYPE_BODY,
            button_qss,
            type_qss,

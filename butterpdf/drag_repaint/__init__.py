...
— which never exercises the buggy path. butterpdf ships a tiny KWin scripted
...
if is_kde_wayland():
    from butterpdf.drag_repaint import _kwin as _backend
else:
    from butterpdf.drag_repaint import _unsupported as _backend
